   ...
   <div className='h-full'>
     <div className='bg-gray-100 h-full'>
      <div  className='flex-col justify-center px-5  '>
        ...
        <div className='flex justify-center'><Image className=' py-5' src="/pic3.png" alt="Car-Image" width={300} height={150}></Image></div>
        ...
        <h3 className='text-green-500 text-3xl text-center pt-7 hover:text-blue-950'>PKR 46.5 - 58.5 lacs</h3>
      </div>
      <Link href="/car3-detail"> <div className='flex justify-center pt-5'><button className='bg-blue-800  hover:bg-black hover:text-white text-white font-semibold text-center rounded-md py-4 px-7 my-6 mx-7 '>More Detail</button></div></Link>
    </div>
   </div>
  )
}
